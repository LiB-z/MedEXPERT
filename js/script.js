...
// Выполнение начнется только после загрузки всего DOM-дерева
...
function initAll() {
	...
	// Прописал условие, при котором код выполняется. Иначе, если нет #footer, будет ошибка
	...
	$(window).on('load', function () {
		changeViewType()
		// Тебе это не нужно, для этого есть css
		if (innerWidth < 425) {
